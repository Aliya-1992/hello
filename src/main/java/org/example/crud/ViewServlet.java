...
import org.example.crud.PersonDao;
...
public class ViewServlet  extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for (Person person :arrayList) {
            printWriter.print("<tr><td>" + person.getId() +"</td> <td>"
                    + person.getUserName() +"</td>  " +
                    "<td>"+ person.getUserPass() +" " +
                    "</td>  <td>"+ person.getUserEmail() +"</td>   <td>"+ person.getUserCountry() +"</td><th><a href = 'delete?id="+ person.getId() +"'>delete</a></th></tr>");
        }
        printWriter.print("</table>");
    }
}*/
